...
HD_PWD='C:/Users/rvelago/ZYBO_Z7/Projects/project_2_PS_Plus_AxiLiteBasic/project_2_PS_Plus_AxiLiteBasic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_lite_min.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_lite_min.tcl
